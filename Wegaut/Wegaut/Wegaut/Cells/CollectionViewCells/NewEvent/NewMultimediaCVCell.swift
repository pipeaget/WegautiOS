...
class NewMultimediaCVCell: UICollectionViewCell {
    ...
    @IBOutlet weak var btnMultimediaImage: UIButton!
    
    //MARK: - FUNCTIONS
    
    func drawCell() {
        guard let aMultimedia = currentMultimedia else { return }
        btnMultimediaImage.setImage(aMultimedia.mulLocalImage,
...
extension NewMultimediaCVCell: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
